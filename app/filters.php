...
App::before(function($request)
{
	...
	if ($posicion_coincidencia > 0) {
	    ...
	    if(Request::url()!='http://'.$cadena_buscada.':82/APPCOFFEE/login'  && !Session::has('Usuario')){

			return Redirect::to('/login');
		}

	    if( (Request::url()=='http://'.$cadena_buscada.':82/APPCOFFEE/login' ||  Request::url()=='http://'.$cadena_buscada.':82/APPCOFFEE')  && Session::has('Usuario')){
